...
public class Complex {
    /*  // tilviksbreytur
      private final double re; // final - get ekki breytt aðferðunum nema í smiðnum
      private final double im;

      // smiður - hér inni má breyta tilviksbreytunum
      public Complex(double real, double imag) {
          this.re = real;
          this.im = imag;
      }

      // generate og toString
